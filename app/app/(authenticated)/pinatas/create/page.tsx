    ...
    try {
      ...
      const createdPinata = await databases.createDocument(
        ...
        ID.unique(),
        {
          ...
          contributeStart: contributeStart ? new Date(contributeStart) : null,
          contributeEnd: contributeEnd ? new Date(contributeEnd) : null,
          minimumOpenTime: minimumOpenTime ? new Date(minimumOpenTime) : null,
